...
public class PayActivity extends AppCompatActivity implements Handler.Callback {
    ...
    public void Pay(String pay) {
        ...
        String orderInfo = getOrderInfo("您的订单需要付款", ":", pay.substring(pay.length() - 3, pay.length()));
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                PayActivity activity = PayActivity.this;
